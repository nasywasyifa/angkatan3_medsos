                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="no_peminjaman" value="<?php echo isset($GET['detail']) ? $rowPeminjam['no_peminjaman'] : $kode_pinjam ?>" readonly>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-sm-4 ms-5">
                            <div class="mb-3">
                                ...
                                <?php if (!isset($_GET['detail'])): ?>
                                    <select required name="id_anggota" id="" class="form-control">
                                        ...
                                        <!-- ini mengambil data dari tabel anggota anggota -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tgl_pengembalian" value="<?php echo isset($_GET['detail']) ? $rowPeminjam['tgl_pengembalian'] : "" ?>"
                                    <?php echo isset($_GET['detail']) ? 'readonly' : '' ?>>
                            </div>
                        </div>
                    </div>
